...
class ModelTest(TestCase):
    ...
    def test_candidate_repr(self):
        ...
        """
        cand = Candidate()
        self.assertEqual(cand.__repr__(), '{"Candidate" : {"name": None, "dob": None, "job": None, "poll": None, "contact": None, "states": None, "party": None, "election": None}}')
    ...
    def test_election_repr(self):
        ...
        """
        elec = Election()
        self.assertEqual(elec.__repr__(), '{"Election" : {"name": None, "date": None, "level": None, "descriptive_name": None}}')
    ...
    def test_party_repr(self):
        ...
        """
        party = Party()
        self.assertEqual(party.__repr__(), '{Party : {"name": None, "hq": None, "leader": None, "abbrev": None}}')
    ...
    def test_state_repr(self):
        ...
        """
        state = State()
        self.assertEqual(state.__repr__(), '{"State" : {"name": None, "capital": None, "population": None, "governor": None, "abbrev": None}}')
    ...
    def test_electoral_college_repr(self):
        ...
        self.assertEqual(electoral_college.__repr__(), '{ElectoralCollege : { "State": None, "Party": None}}')
    ...
    def test_electoral_college_1(self):
        ...
        """
        query = ElectoralCollege.query.filter(ElectoralCollege.state_name == "Georgia").first()
    ...
    def test_electoral_college_2(self):
        ...
        """
        electoral_query = ElectoralCollege.query.filter(ElectoralCollege.state_name == "Georgia").first()
        party_query = Party.query.filter(Party.name == "Republican Party").first()
    ...
    def test_electoral_college_3(self):
        ...
        """
        electoral_query_1 = ElectoralCollege.query.filter(ElectoralCollege.state_name == "Georgia").first()
        electoral_query_2 = ElectoralCollege.query.filter(ElectoralCollege.state_name == "Texas").first()
        party_query = Party.query.filter(Party.name == "Republican Party").first()
    ...
    def test_parties_involved_repr(self):
        ...
        self.assertEqual(parties_involved.__repr__(), '{"PartiesInvolved": {"Party": None, "Election": None}}')
    ...
    def test_parties_involved_1(self):
        ...
        """
        query = PartiesInvolved.query.filter(PartiesInvolved.election_id == 1).first()
        self.assertEqual(query.party.name, "Republican Party")
    ...
    def test_parties_involved_2(self):
        ...
        """
        involved_query = PartiesInvolved.query.filter(PartiesInvolved.election_id == 1).first()
        party_query = Party.query.filter(Party.name == "Republican Party").first()
        election_query = Election.query.filter(Election.name == "MO-S-00").first()
    ...
    def test_parties_involved_3(self):
        ...
        """
        involved_query_1 = PartiesInvolved.query.filter(PartiesInvolved.election_id == 1).first()
        involved_query_2 = PartiesInvolved.query.filter(PartiesInvolved.election_id == 3).first()
        party_query = Party.query.filter(Party.name == "Republican Party").first()
    ...
    def test_elections_to_state_repr(self):
        ...
        self.assertEqual(elections_to_state.__repr__(), '{"ElectionsToStates" : {"elections": None, "states":None}}')
    ...
    def test_elections_to_state_1(self):
        ...
        """
        query = ElectionsToState.query.filter(ElectionsToState.election_id == 1).first()
    ...
    def test_elections_to_state_2(self):
        ...
        """
        elections_to_state_query = ElectionsToState.query.filter(ElectionsToState.election_id == 1).first()
    ...
    def test_elections_to_state_3(self):
        ...
        """
        elections_to_states_1 = ElectionsToState.query.filter(ElectionsToState.election_id == 1).first()
        # print(elections_to_states_1)
        elections_to_states_2 = ElectionsToState.query.filter(ElectionsToState.election_id == 330).first()
